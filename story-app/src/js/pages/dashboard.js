...
const Dashboard = {
  ...
  _populateDetailTransactionToModal(transactionRecord) {
    ...
    const imgProfileDetailRecord = document.querySelector(
      "#recordDetailModal #imgProfileDetailRecord",
    );
    ...
    dateDetailRecord.textContent = this._formatDate(
